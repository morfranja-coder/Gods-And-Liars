...
const GOD_INTRO_MS := 14000
const NIGHT_START_MS := 3000

const HERETIC_ACTION_MS := 25000
const HEALER_ACTION_MS := 10000
const INQUISITOR_ACTION_MS := 20000
...
static func deadline_ms(
	phase: GameManager.MatchPhase,
	now_ms: int
) -> int:
	var duration: int = timeout_ms_for_phase(phase)
